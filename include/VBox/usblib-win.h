/** @file
 * USBLib - Library for wrapping up the NtesUSB functionality, Windows flavor.
 * (DEV,HDrv,Main)
 */
...
DEFINE_GUID(GUID_CLASS_VBOXUSB, 0x873fdf, 0xCAFE, 0x81EE, 0xaa, 0x5e, 0x0, 0xc0, 0x4f, 0xb1, 0x72, 0xb);

#define USBFLT_SERVICE_NAME              "\\\\.\\NtesUSBFlt"
#define USBFLT_NTDEVICE_NAME_STRING      L"\\Device\\NtesUSBFlt"
#define USBFLT_SYMBOLIC_NAME_STRING      L"\\DosDevices\\NtesUSBFlt"

#define USBMON_SERVICE_NAME_W              L"NtesUSBMon"
#define USBMON_DEVICE_NAME               "\\\\.\\NtesUSBMon"
#define USBMON_DEVICE_NAME_NT            L"\\Device\\NtesUSBMon"
#define USBMON_DEVICE_NAME_DOS           L"\\DosDevices\\NtesUSBMon"
